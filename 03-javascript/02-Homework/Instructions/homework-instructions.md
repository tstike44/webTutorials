...
* Fill out the information (name is Word-Guess-Game or Psychic-Game) and make sure to select initialize repository with a README.
...
* then change directories into the newly created folder e.g. Word-Guess-Game  ```cd Word-Guess-Game``` or for Psychic-Game  ```cd Psychic-Game```
...
* Please submit the links outlined in the directions at the end of these instructions.

### Before You Begin

1. Create a new GitHub repo called `Word-Guess-Game` or `Psychic-Game`, in accordance with the assignment you choose to complete. Then, clone it to your computer using steps outlined above.
...
5. Commit changes when you want to make a save point.
...
8. Push your selected game to Github Pages using steps below when finished.
...
* Copy link for pull request and paste into bootcamp spot. (e.g. https://github.com/jtblanche/Psychic-Game/pull/1)

* Go to your repository's settings and find the github pages link and check that that is working, then paste it into bootcamp spot as well. (e.g. https://jtblanche.github.io/Psychic-Game)