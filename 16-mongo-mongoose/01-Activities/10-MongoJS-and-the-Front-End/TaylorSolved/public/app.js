...
function displayResults(animals) {
  ...
  for(var i = 0; i < animals.length; i++) {
    ...
    console.log(animal);
    var animalRow = $('<tr><td>' + animal.name + '</td><td>' + animal.numLegs
    + '</td><td>' + animal.class + '</td><td>' + animal.weight + '</td><td>' 
    + animal.whatIWouldReallyCallIt + '</td></tr>');
    table.append(animalRow);
  }
}
