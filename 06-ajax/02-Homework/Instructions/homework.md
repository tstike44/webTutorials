...
* Fill out the information (name is GifTastic) and make sure to select initialize repository with a README.
...
* then change directories into the newly created folder e.g. unit-4-game  ```cd GifTastic```
